            ...
            @else
                ...
                >
                    ...
                    <a
                        href="#"
                        role="button"
                        :title=__('filament-cms::forms.field.edit')
                    ...
                    >
                        ...
                        <x-heroicon-m-pencil-square
                            stroke-width="2"
                            class="h-4 w-4 ext-primary-600 dark:text-primary-400"
                        />

                        <span class="sr-only">{{ __('filament-cms::forms.field.edit') }}</span>

                    </a>

                    <span x-show="!editing && context !== 'create' && modified"> [{{ __('filament-cms::forms.field.changed') }}]</span>
                ...
                >
                    ...
                    <a
                        ...
                        "
                    >
                        {{ __('filament-cms::forms.field.ok') }}
                    </a>
                    ...
                    <x-filament::link
                        ...
                        color="gray"
                        size="sm"
                        title="{{ __('filament-cms::forms.field.reset') }}"
                    >
                        <span class="sr-only"> {{ __('filament-cms::forms.field.reset') }}</span>
                    </x-filament::link>
                    ...
                    <x-filament::link
                        ...
                        color="gray"
                        size="sm"
                        title=" {{ __('filament-cms::forms.field.cancel') }}"
                    >
                        <span class="sr-only"> {{ __('filament-cms::forms.field.cancel') }}</span>
                    </x-filament::link>
